...
async function initializeContent() {
  try {
    ...
    const socialIconMap = {
      ...
      goodreads: `<svg class="social-icon" viewBox="0 0 122.88 122.88" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" clip-rule="evenodd" fill="#E7E3C7" d="M16.379 0h90.122c9.009 0 16.379 7.371 16.379 16.379v90.122c0 9.009-7.37 16.38-16.379 16.38H16.379C7.371 122.881 0 115.51 0 106.501V16.379C0 7.371 7.371 0 16.379 0"/><path fill="#6C3D0D" d="M61.661 25.795c-6.29 0-11.108 2.514-14.427 6.549-3.796 4.615-5.716 11.237-5.716 18.447 0 7.221 1.859 13.573 5.42 17.972 3.203 3.956 7.851 6.349 13.824 6.349 6.332 0 11.27-2.457 14.685-6.444 3.811-4.448 5.803-10.819 5.803-17.876q0-.097.009-.192l.001-.093h-.009c0-6.404-1.729-12.644-5.091-17.262-3.248-4.462-8.061-7.411-14.34-7.456l-.159-.001zm19.694 45.917a23.7 23.7 0 0 1-4.634 4.585c-4.561 3.427-10.285 5.278-15.833 5.278-8.188 0-14.444-3.276-18.772-8.521-4.7-5.695-7.043-13.695-7.043-22.263 0-8.867 2.463-16.973 7.262-22.739 4.495-5.401 10.972-8.729 19.326-8.729 5.821 0 11.037 1.996 15.135 5.294a24.3 24.3 0 0 1 4.56 4.841v-8.275h6.451v58.564c0 8.561-2.335 14.968-6.635 19.326-4.499 4.563-11.032 6.776-19.187 6.776-6.623 0-12.788-1.722-17.215-5.58-3.928-3.422-6.427-8.451-6.597-15.348v-.039h6.451l-.001.073c.215 4.853 1.93 8.297 4.589 10.573 3.133 2.682 7.661 3.851 12.664 3.851 6.41 0 11.369-1.577 14.631-4.854 3.163-3.178 4.849-8.063 4.849-14.778v-8.035z"/></svg>`,
